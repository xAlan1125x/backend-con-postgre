  ...
  paths: {
    ...
    "/api/v1/productos/{id}": {
      ...
      get: {
        ...
        responses: { "200": { description: "Producto encontrado" }, "404": { description: "Producto inexistente" } }
      },
      put: {
        summary: "Actualizar un producto",
        requestBody: {
          required: true,
          content: { "application/json": { schema: { $ref: "#/components/schemas/ActualizarProductoDto" } } }
        },
        responses: { "200": { description: "Producto actualizado" }, "404": { description: "Producto inexistente" } }
      },
      delete: {
        summary: "Eliminar un producto",
        responses: { "204": { description: "Producto eliminado" }, "404": { description: "Producto inexistente" } }
      }
    },
    "/api/v1/categorias": {
      get: {
    ...
    "/api/v1/categorias/{id}": {
      ...
      get: {
        ...
        responses: { "200": { description: "Categoría encontrada" }, "404": { description: "Categoría inexistente" } }
      },
      put: {
      ...
      delete: {
        ...
        responses: { "204": { description: "Categoría eliminada" }, "404": { description: "Categoría inexistente" } }
      }
    },
    "/api/pedidos": {
      post: {
    ...
    schemas: {
      Producto: {
        ...
        properties: {
          ...
          stock: { type: "integer" }, categoria_id: { type: "integer", nullable: true }
        }
      },
      CrearProductoDto: {
        type: "object", required: ["nombre", "precio", "categoria_id"],
        properties: {
          nombre: { type: "string", minLength: 1 }, precio: { type: "number", exclusiveMinimum: 0 },
          stock: { type: "integer", minimum: 0 }, categoria_id: { type: "integer", minimum: 1 }
        }
      },
      ActualizarProductoDto: {
        type: "object",
        properties: {
          nombre: { type: "string" }, precio: { type: "number", exclusiveMinimum: 0 },
          stock: { type: "integer", minimum: 0 }, categoria_id: { type: "integer", minimum: 1 }
        }
      },
      Categoria: {
        type: "object",
        properties: {
          id: { type: "integer" }, nombre: { type: "string" }, descripcion: { type: "string" }
        }
      },
      CrearCategoriaDto: {
        type: "object", required: ["nombre"],
        properties: { nombre: { type: "string", minLength: 3 }, descripcion: { type: "string" } }
      },
