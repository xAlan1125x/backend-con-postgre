...
import RoundRobinPool from 'undici-types/round-robin-pool'
...
import Dispatcher1Wrapper from 'undici-types/dispatcher1-wrapper'
...
import Socks5ProxyAgent from 'undici-types/socks5-proxy-agent'
...
import CacheInterceptor from 'undici-types/cache-interceptor'
...
declare namespace Undici {
  ...
  const RoundRobinPool: typeof import('undici-types/round-robin-pool').default
  ...
  const Dispatcher1Wrapper: typeof import('undici-types/dispatcher1-wrapper').default
  ...
  const ProxyAgent: typeof import('undici-types/proxy-agent').default
  const Socks5ProxyAgent: typeof import('undici-types/socks5-proxy-agent').default
